...
function bot_ui_ini() {
    ...
    var sure = function() {
        ...
        secondpart = function() {
            botui.message.add({
                delay: 1500,
                content: "现就读于天津工业大学（好像改名了呢）"
            }).then(function() {
                botui.message.add({
                    delay: 1500,
                    content: "迫于“形势”学了软件，其实现在有点沉迷其中无法自拔"
                }).then(function() {
                    botui.message.add({
                        delay: 1200,
                        content: "没办法，我就是一个善变的人（每个季度换一次老婆？）"
                    }).then(function() {
                        botui.message.add({
                            delay: 1500,
                            content: "本想将来做游戏（主要想做Galgame）"
                        }).then(function() {
                            botui.message.add({
                                delay: 1500,
                                content: "然而迫于压力JAVA写得比C++多（甚至学了Springboot和struts2）"
                            }).then(function() {
                                botui.message.add({
                                    delay: 1500,
                                    content: "还被迫搞过图像处理"
                                    ...
                                    botui.message.add({
                                        ...
                                        botui.message.add({
                                            ...
                                            botui.message.add({
                                                delay: 1500,
                                                content: "其实还玩过AE和PR，后来发现还是玩不过那帮科班出身的（看着硬盘里躺着的好几个MAD，无能狂怒！）"
                                            }).then(function() {
                                    botui.message.add({
                                        delay: 1800,
                                        content: "想画画，但是画的奇丑无比（你这画除了透视和形是错的，剩下还可以）"
                                    }).then(function() {
                                        botui.action.button({
                                            delay: 1100,
                                            action: [{
                                                ...
                                                text: "我明白了！你就是个肥宅Hentai！",
                                                value :"hentai"
                                            }]
                                        }).then(function(a) {
                                            "why-yukina"== a.value&&thirdpart();
                                            "hentai"==a.value&&fourthpart();
                                        })
                                    })
                                })
                            })
        ...
        thirdpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "Yukina其实是觉得Yukinagi四个音节太长了把nagi（凪）的一个音节去掉的产物"
            }).then(function() {
                botui.message.add({
                    delay: 1500,
                    content: "雪停了的意思"
                    ...
                    botui.message.add({
                        delay: 1500,
                        content: "其实还有两个字Hnasaki(花咲)，花开了的意思"
                    }).then(function() {
                        botui.message.add({
                            delay: 1500,
                            content: "具体意思我觉得已经很明朗了，聪明的你一定懂我想说啥(●ˇ∀ˇ●)"
                        }).then(function() {
                botui.action.button({
                    delay: 1500,
                    action: [{
        ...
        fourthpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "男人变态有什么错（卡密脸）"
            }).then(function() {
                botui.message.add({
                    delay: 1100,
                    content: "再说我也是社会主义好公民，只不过人有写菜"
                }).then(function() {
                    botui.action.button({
                        delay: 1500,
                        action: [{
        ...
        fifthpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "好吧，那么，如果是“同道中人”，我们可以深入♂/♀交流哦"
            }).then(function() {
                botui.message.add({
                    delay: 1600,
                    content: "良い生活を ^_^"
